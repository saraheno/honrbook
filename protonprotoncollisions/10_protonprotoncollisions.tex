...
\begin{equation}\frac{dN}{dt}=\Phi !I could not figure out how to this simble here here!\end{equation}
...
\begin{equation}!!!!I don't even no what to look up to add this math!!!!\end{equation}
...
\begin{figure}[h]
\centering\includegraphics[scale=0.5]{./protonprotoncollisions/Pictures/fig11.pdf}
\caption{!!!NO CAPTION!!!}
\label{fig:pdgdedx}
\end{figure}

\begin{figure}[h]
\centering\includegraphics[scale=0.5]{./protonprotoncollisions/Pictures/fig12.pdf}
\caption{!!!NO CAPTION!!!}
\label{fig:pdgdedx}
\end{figure}
