...
\begin{center}
        ...
        \vspace*{2cm}%
       \par\nobreak
    \makebox[0pt]{\Huge \bfseries  Book Title} 
        \vspace*{2cm}%
\par\nobreak
{\includegraphics[width=\linewidth,height=10cm]{Pictures/chapter_head_1.eps}}
        \par\nobreak
 \vspace*{2cm}%
...
%   {\transparent{0.4}\includegraphics[width=8in, height=11in]{chapter_head_1.pdf}}}}%%
%\BgThispage
 %Some content
...
\chapterimage{chapter_head_1.eps} % Table of contents heading image
...
%%%\begin{center}
  ...
  %%%      \vspace*{1cm}%
  %%%     \par\nobreak
 %%%   \makebox[0pt]{\Huge \bfseries  Table of Contents} 
 %%%       \vspace*{1cm}%
%%%\par\nobreak
%{\includegraphics[width=\linewidth,height=10cm]{chapter_head_1.pdf}}
%%%        \par\nobreak
%%%      {\color{ocre}\thickhrule}
%%%  \end{center}
...
%	CHAPTER 1
%----------------------------------------------------------------------------------------
\chapterimage{Pictures/chapter_head_2.eps} % Chapter heading image
