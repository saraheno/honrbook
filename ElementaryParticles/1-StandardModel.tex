...
Figure 1: Scale of fundamental particles
...
The figure below shows the “LO” diagram for annihilation of an up quark and an anti-up quark to a Z boson to an electron-positron pair.

 

The figure below shows a NNLO (in the strong force) diagram for the same process.
...
•	pdg.lbl.gov is always a great site for all things related to particle physics
